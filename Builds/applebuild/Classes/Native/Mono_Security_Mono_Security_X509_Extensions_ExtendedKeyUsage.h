...
struct  ExtendedKeyUsageExtension_t1199  : public X509Extension_t1005
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t936 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1199_StaticFields{
	...
	Dictionary_2_t497 * ___U3CU3Ef__switch$map14_4;
};
