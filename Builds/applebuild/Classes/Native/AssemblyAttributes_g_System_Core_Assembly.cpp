...
void g_System_Core_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	...
	{
		ExtensionAttribute_t892 * tmp;
		tmp = (ExtensionAttribute_t892 *)il2cpp_codegen_object_new (&ExtensionAttribute_t892_il2cpp_TypeInfo);
		ExtensionAttribute__ctor_m3823(tmp, &ExtensionAttribute__ctor_m3823_MethodInfo);
	...
	}
	{
		...
		AssemblyDefaultAliasAttribute__ctor_m3853(tmp, il2cpp_codegen_string_new_wrapper("System.Core.dll"), &AssemblyDefaultAliasAttribute__ctor_m3853_MethodInfo);
	...
	}
	{
		...
		AssemblyDescriptionAttribute__ctor_m2128(tmp, il2cpp_codegen_string_new_wrapper("System.Core.dll"), &AssemblyDescriptionAttribute__ctor_m2128_MethodInfo);
	...
	}
	{
		...
		AssemblyTitleAttribute__ctor_m2127(tmp, il2cpp_codegen_string_new_wrapper("System.Core.dll"), &AssemblyTitleAttribute__ctor_m2127_MethodInfo);
